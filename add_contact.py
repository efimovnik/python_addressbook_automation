...
class TestAddNewContact(unittest.TestCase):
    ...
    def test_add_contact(self):
        ...
        self.fill_personal_information(wd, Contact(firstname="Nickolay", middlename="Igorevich", lastname="Efimov", nickname="kolya", title="Title", company="Company", photo="D:\\testpicture.jpg", address="Address", home_phone="HomePhone", work_phone="MobilePhone", mobile_phone="WorkPhone", fax_number="FaxNumber", email="email1@mail.ru", email2="email2@mail.ru", email3="email3@mail.ru", homepage="homepage.ru", birth_day="17", birth_month="November", birth_year="1995", anniversary_day="18", anniversary_month="December", anniversary_year="1996", group="gav1", address2="address", phone_number_2="HomeAddress", notes="Notes"))
    ...
    def test_add_empty_contact(self):
        ...
        self.login(wd, username="admin", password="secret")
        self.init_add_new_contact(wd)
        self.fill_personal_information(wd, Contact(firstname="", middlename="", lastname="", nickname="", title="", company="", photo="", address="", home_phone="", work_phone="", mobile_phone="", fax_number="", email="", email2="", email3="", homepage="", birth_day="", birth_month="-", birth_year="", anniversary_day="", anniversary_month="-", anniversary_year="", group="", address2="", phone_number_2="", notes=""))
        self.confirm_group_creation(wd)
        self.logout(wd)
